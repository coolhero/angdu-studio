...
- 002-ai-provider: Added TypeScript 5.8, targeting ES2022 + Vercel AI SDK 6 (`ai`), Zustand 5.x, electron-store 10.x, Zod (provider type validation)

- 001-app-core: Added TypeScript 5.8, targeting ES2022 + Electron 40, React 19, electron-vite 3.x + SWC, Zustand 5.x, electron-store 10.x, electron-updater 6.x, electron-window-state 5.x
